...
export function decodeExecuteFlashloan(
	data: Hex,
): [Address[], BigInt[], Hex, Boolean] {
	const callData = Trinity.neo_interface.decodeFunctionData(
...
export function decodeExecuteFlashloanWithReceiver(
	data: Hex,
): [Address[], Address[], BigInt[], Hex, Address, Boolean] {
	const callData = Trinity.neo_interface.decodeFunctionData(
...
export function decodeMulticallFlashloan(
	data: Hex,
): [Address, BigInt, any, any] {
...
export function decodeMulticall(data: Hex): [BigInt, Hex[], BigInt[]] {
	const callData = Trinity.interface.decodeFunctionData(
...
export function decodeMulticallWithReceiver(
	data: Hex,
): [Address[], BigInt, Hex[], BigInt[], Address] {
	const callData = Trinity.interface.decodeFunctionData(
	...
	const decodedMulticallData = Trinity.neo_interface.decodeFunctionData(
		"multicall(uint256,bytes[],uint256[])",
		multicallData,
	);
...
export function decodeSupplyWithMaxGas(
	data: Hex,
): [Hex, Address, Address, Hex, BigInt, BigInt] {
	...
	const callData = Trinity.morpho_module_interface.decodeFunctionData(
...
export function decodeSupplyWithoutMaxGas(
	data: Hex,
): [Hex, Address, Address, Hex, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeSupplyAaveV3(
	data: Hex,
): [Hex, Address, BigInt, Address, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeSupplyCollateralAaveV3(
	data: Hex,
): [Hex, Address, BigInt, Address] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeWithdrawAaveV3(
	data: Hex,
): [Hex, Address, BigInt, Address, Address, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeWithdrawCollateralAaveV3(
	data: Hex,
): [Hex, Address, BigInt, Address, Address] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
/// --- MORPHO BORROW/REPAY
///////////////////////////////////////////////////////////////
export function decodeBorrowWithMaxGas(
	data: Hex,
): [Hex, Address, Address, BigInt, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeBorrowWithoutMaxGas(
	data: Hex,
): [Hex, Address, Address, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeBorrowWithReceiver(
	data: Hex,
): [Hex, Address, BigInt, Address, Address, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
...
export function decodeRepay(
	data: Hex,
): [Hex, Address, Address, Address, BigInt] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeClaimRewards(
	data: Hex,
): [Hex, Address, Address[], Boolean] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
...
export function decodeApproveToken(data: Hex): [Hex, Address, Address, BigInt] {
	...
	const callData = Trinity.token_module_interface.decodeFunctionData(
...
export function decodeExchange(
	data: Hex,
): [Hex, Address, Address, Address, BigInt, Hex] {
	const decodedData = decodeAbiParameters(
		parseAbiParameters("bytes1, bytes"),
		data,
	);
	...
	const callData = Trinity.aggregators_module_interface.decodeFunctionData(
