...
export async function getParaswapPrices(tokenIn: Token, tokenOut: Token, amount: string, formated?: boolean) {
  const queryParams = {
...
export async function getParaswapBuyPrices(tokenIn: Token, tokenOut: Token, amount: string) {
  const queryParams = {
    srcToken: tokenIn.address,
    destToken: tokenOut.address,
    srcDecimals: tokenIn.decimals.toString(),
